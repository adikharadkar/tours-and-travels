...
export default function VehicleCard({
  ...
  return (
    <Card
      className={[
        "transition-all duration-200 border border-slate-200 dark:border-[#27272a] bg-white dark:bg-[#121314]",
        highlighted
          ? "ring-2 ring-primary/40 shadow-sm"
          : "hover:border-slate-300 dark:hover:border-[#38393a]",
      ].join(" ")}
    >
      <CardContent className="p-4 flex flex-col justify-between h-full">
        <div>
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <h3 className="truncate text-base font-bold font-mono tracking-tight text-slate-900 dark:text-[#e3e2e3]">
            ...
            <div className="flex flex-col items-end gap-1 shrink-0">
              ...
              {operational.operationalStatus === "on_trip" && (
                <span className="inline-flex items-center gap-1 rounded px-1.5 py-0.5 text-[10px] font-medium bg-purple-500/10 text-purple-600 dark:text-purple-300 border border-purple-500/20">
          ...
          {/* Details Grid */}
          <div className="mt-3.5 space-y-2 text-xs divide-y divide-slate-100 dark:divide-[#27272a]/60">
            <div className="flex items-center justify-between gap-2 pt-1">
              <span className="text-slate-500 dark:text-[#958ea0]">
                Make / Model
              </span>
              <span className="truncate font-medium text-slate-900 dark:text-[#e3e2e3]">
            ...
            <div className="flex items-center justify-between gap-2 pt-1.5">
              ...
              <span className="font-medium text-slate-900 dark:text-[#e3e2e3]">
            ...
            <div className="flex items-center justify-between gap-2 pt-1.5">
              ...
              <div className="flex flex-col items-end">
                ...
                />
                {criticalDoc && (
                  <span className="text-[10px] text-slate-500 dark:text-[#958ea0] mt-0.5 truncate max-w-[140px]">
                    {criticalDoc.name}
        ...
        {/* Actions Bar */}
        <div className="mt-4 flex items-center justify-end gap-1.5 border-t border-slate-100 dark:border-[#27272a] pt-3">
          <Button
            type="button"
            variant="ghost"
            size="sm"
            onClick={() => onView(vehicle)}
            className="text-xs h-7 px-2.5 text-slate-700 dark:text-[#cbc3d7] hover:text-slate-900 dark:hover:text-white"
          >
            View
          </Button>
